...
# Server Setup Script - Initial Ubuntu Server Configuration
# This script installs all required services and configurations for the Email Service
...
print_step "Starting Server Setup"
...
echo ''
echo 'All 4 services verified successfully!'
echo '==========================='
...
# Step 5: Configure Nginx (base configuration)
print_step "Configuring Nginx Base"
execute_ssh "
...
execute_ssh "
mkdir -p /var/www/EmailService
chown -R www-data:www-data /var/www/EmailService
echo 'Application directory created'
" "Creating application directory"

# Summary
print_step "Server Setup Complete!"
print_success "Server is ready for application deployment!"
echo ""
echo -e "${GREEN}🎉 SERVER SETUP SUMMARY 🎉${NC}"
echo "=============================="
echo -e "✅ Server: ${YELLOW}$SERVER_IP${NC}"
echo -e "✅ Domain: ${YELLOW}https://$DOMAIN${NC}"
echo -e "✅ MySQL: ${YELLOW}Configured with password: $MYSQL_PASSWORD${NC}"
echo -e "✅ Nginx: ${YELLOW}Configured with SSL${NC}"
echo -e "✅ .NET 9: ${YELLOW}Runtime installed${NC}"
echo -e "✅ Firewall: ${YELLOW}Configured with necessary ports${NC}"
echo ""
echo -e "${BLUE}🔧 Next Step:${NC}"
echo -e "   Run ${YELLOW}./service-deploy.sh${NC} to deploy the application"
echo ""
