...
{
    public class SIPEmailService : IEmailService
    {
        private readonly EmailDbContext _context;
        private readonly ILogger<SIPEmailService> _logger;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public SIPEmailService(EmailDbContext context, ILogger<SIPEmailService> logger, IHttpContextAccessor httpContextAccessor)
        {
            _context = context;
            _logger = logger;
        ...
        public async Task<bool> SendContactUsEmailAsync(ContactUsRequest request)
        {
            try
            {
                ...
                var clientSubject = "Thank You for Contacting Strategic IT Partners UK - We'll Be In Touch Soon";
                var clientBody = $@"
                <html>
                <head>
                    <meta charset='UTF-8'>
                    <meta name='viewport' content='width=device-width, initial-scale=1.0'>
                    <title>Thank You - Strategic IT Partners UK</title>
                </head>
                <body style='font-family: Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0; background-color: #f4f4f4;'>
                    <div style='max-width: 600px; margin: 20px auto; background-color: #ffffff; border-radius: 10px; box-shadow: 0 0 20px rgba(0,0,0,0.1); overflow: hidden;'>
                        <div style='background: linear-gradient(135deg, #DE532A, #c44622); color: white; padding: 30px 20px; text-align: center;'>
                            ...
                            <p style='margin: 5px 0 0 0; font-size: 14px; opacity: 0.9;'>Strategic IT Partners UK - Manchester</p>
                        </div>
                        <div style='padding: 30px 20px;'>
                            <div style='margin-bottom: 30px;'>
                                <p style='font-size: 16px; color: #2c3e50; margin: 0 0 20px 0; line-height: 1.5;'>
                                    Dear {request.Name},<br><br>
                                    Thank you for reaching out to Strategic IT Partners UK. We have successfully received your inquiry and wanted to confirm the details you provided:
                                </p>
                            </div>
                        ...
                        <div style='background-color: #f8f9fa; padding: 25px 20px; border-top: 1px solid #e1e5e9;'>
                            ...
                            <p style='margin: 0 0 5px 0; font-weight: bold; color: #DE532A; font-size: 16px;'>Strategic IT Partners UK Team</p>
                            <p style='margin: 0 0 15px 0; font-style: italic; color: #666; font-size: 14px;'>Your Digital Success Partner</p>
                        </div>
                ...
                // Send notification email to SIP team
                ...
                <head>
                    <meta charset='UTF-8'>
                    <meta name='viewport' content='width=device-width, initial-scale=1.0'>
                    <title>New Contact Form Submission - Strategic IT Partners UK</title>
                </head>
                <body style='font-family: Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0; background-color: #f4f4f4;'>
                    <div style='max-width: 600px; margin: 20px auto; background-color: #ffffff; border-radius: 10px; box-shadow: 0 0 20px rgba(0,0,0,0.1); overflow: hidden;'>
                        <div style='background: linear-gradient(135deg, #DE532A, #c44622); color: white; padding: 30px 20px; text-align: center;'>
                            <h1 style='margin: 0; font-size: 24px; font-weight: bold;'>🚨 New Contact Form Submission</h1>
                            <p style='margin: 5px 0 0 0; font-size: 14px; opacity: 0.9;'>Strategic IT Partners UK Website</p>
                        </div>
                        <div style='padding: 30px 20px;'>
                            <div style='margin-bottom: 30px;'>
                                <p style='font-size: 16px; color: #2c3e50; margin: 0 0 20px 0; line-height: 1.5;'>
                        ...
                        <div style='background-color: #2c3e50; color: #bdc3c7; padding: 15px 20px; text-align: center;'>
                            <p style='margin: 0; font-size: 12px;'>
                                Internal notification - Strategic IT Partners UK Contact Form System
                            </p>
                        </div>
                    </div>
                </body>
                ...
                var teamEmailSent = await SendEmailAsync(request.AppId, "Contactus@sipoperations.co.uk", teamSubject, teamBody, "ContactUs_TeamNotification", teamMetadata);
        ...
        public async Task<bool> SendEnquiryEmailAsync(EnquiryRequest request)
        {
            ...
            {
                // Send acknowledgment email to client
                var clientSubject = "Thank You for Your Service Enquiry - Strategic IT Partners UK";
                ...
                var teamEmailSent = await SendEmailAsync(request.AppId, "Contactus@sipoperations.co.uk", teamSubject, teamBody, "Enquiry_TeamNotification", teamMetadata);
                    ...
                    <div style='max-width: 600px; margin: 20px auto; background-color: #ffffff; border-radius: 10px; box-shadow: 0 0 20px rgba(0,0,0,0.1); overflow: hidden;'>
                        ...
                        <div style='padding: 30px 20px;'>
                            ...
                            <div style='background-color: #fff; padding: 20px; border-radius: 8px; margin-bottom: 30px; border: 1px solid #e1e5e9; border-left: 5px solid #3498db;'>
                                ...
                                <p style='margin: 0 0 8px 0; font-size: 14px; color: #333;'><strong>📞 Phone:</strong> <a href='tel:00 44 7543361019' style='color: #DE532A; text-decoration: none;'>0161 466 1280</a></p>
                                <p style='margin: 0 0 8px 0; font-size: 14px; color: #333;'><strong>✉️ Email:</strong> <a href='mailto:Contactus@sipoperations.co.uk' style='color: #DE532A; text-decoration: none;'>Contactus@sipoperations.co.uk</a></p>
                                <p style='margin: 0 0 8px 0; font-size: 14px; color: #333;'><strong>🌐 Website:</strong> <a href='https://www.sipoperations.co.uk/' target='_blank' style='color: #DE532A; text-decoration: none;'>www.mcrsolicitors.co.uk</a></p>
                                <p style='margin: 0 0 0 0; font-size: 14px; color: #333;'><strong>🏢 Address:</strong> Fair Oak Road, Manchester, M19 1DT</p>
                            </div>
                        </div>
        ...
        private string GenerateEnquiryAcknowledgmentEmail(EnquiryRequest request)
        {
            return $@"
                ...
                <head>
                    <meta charset='UTF-8'>
                    <meta name='viewport' content='width=device-width, initial-scale=1.0'>
                    <title>Thank You for Your Enquiry - Strategic IT Partners UK</title>
                </head>
                <body style='font-family: Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0; background-color: #f4f4f4;'>
                    <div style='max-width: 600px; margin: 20px auto; background-color: #ffffff; border-radius: 10px; box-shadow: 0 0 20px rgba(0,0,0,0.1); overflow: hidden;'>
                        ...
                        <div style='padding: 30px 20px;'>
                            ...
                            <div style='background-color: #e8f5e8; padding: 20px; border-radius: 8px; margin-bottom: 25px; border-left: 5px solid #27ae60;'>
                                ...
                                <ul style='margin: 0; padding-left: 20px; line-height: 1.8;'>
                                    ...
                                    <li style='margin-bottom: 8px; color: #2c3e50;'>A Tech Specialist will contact you to discuss your requirements</li>
        ...
        private string GenerateEnquiryNotificationEmail(EnquiryRequest request)
        {
            return $@"
                ...
                <head>
                    <meta charset='UTF-8'>
                    <meta name='viewport' content='width=device-width, initial-scale=1.0'>
                    <title>Service Enquiry - Strategic IT Partners UK</title>
                </head>
                <body style='font-family: Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0; background-color: #f4f4f4;'>
                    <div style='max-width: 600px; margin: 20px auto; background-color: #ffffff; border-radius: 10px; box-shadow: 0 0 20px rgba(0,0,0,0.1); overflow: hidden;'>
                        ...
                        <div style='background-color: #f8f9fa; padding: 25px 20px; border-top: 1px solid #e1e5e9;'>
                            <div style='text-align: left;'>
                                <p style='margin: 0 0 15px 0; font-weight: bold; color: #2c3e50; font-size: 16px;'>Kind Regards,</p>
                                <p style='margin: 0 0 5px 0; font-weight: bold; color: #DE532A; font-size: 16px;'>Strategic IT Partners</p>

                                <div style='border-top: 1px solid #e1e5e9; padding-top: 15px; margin-top: 15px;'>
                                    <p style='margin: 0 0 8px 0; font-size: 14px; color: #333;'><strong>📞 Direct:</strong> <a href='tel:00 44 7543361019' style='color: #DE532A; text-decoration: none;'>0161 466 1280</a></p>
                                    <p style='margin: 0 0 8px 0; font-size: 14px; color: #333;'><strong>✉️ Email:</strong> <a href='mailto:Contactus@sipoperations.co.uk' style='color: #DE532A; text-decoration: none;'>Contactus@sipoperations.co.uk</a></p>
                                    <p style='margin: 0 0 8px 0; font-size: 14px; color: #333;'><strong>🌐 Website:</strong> <a href='https://www.sipoperations.co.uk/' target='_blank' style='color: #DE532A; text-decoration: none;'>www.mcrsolicitors.co.uk</a></p>
                                    <p style='margin: 0 0 0 0; font-size: 14px; color: #333;'><strong>🏢 Address:</strong> Fair Oak Road, Manchester, M19 1DT</p>
                                </div>
